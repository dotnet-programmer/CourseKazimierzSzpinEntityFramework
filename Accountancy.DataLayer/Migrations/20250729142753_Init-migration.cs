        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Nip = table.Column<string>(type: "nvarchar(13)", maxLength: 13, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AttributeProduct", x => new { x.AttributeId, x.ProductId });
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                table: "Customers",
                columns: new[] { "CustomerId", "Email", "Name", "Nip", "PhoneNumber" },
                values: new object[] { 1, "jakis.mail@poczta.pl", "Maciek Kowalski", "111-222-33-44", "1234567890" });
